...
![network-1](http://put/image/here "Initial Commit Network Image")
...
![network-2](http://put/image/here "After git flow init")
...
![network-newfeature](http://put/image/here "After pushing feature branch")
...
![network-after-feature-merge](http://put/image/here "After pushing merging")
